...
fn conformance_cursor_basic() {
    check(&[
        ...
        Case {
            name: "cub",
            input: b"\x1b[1;6H\x1b[3D",
            cursor: Some((0, 2)),
            ..BASE
        },
        Case {
            name: "cub_saturates",
            input: b"\x1b[1;2H\x1b[9D",
            cursor: Some((0, 0)),
            ..BASE
        },
        ...
        Case {
            name: "cuu_clamps_top",
            input: b"\x1b[3;1H\x1b[10A",
            cursor: Some((0, 0)),
            ..BASE
        },
        Case {
            name: "cup_clamps_outside",
            input: b"\x1b[100;100H",
            cursor: Some((7, 23)),
            ..BASE
        },
        Case {
            name: "cuf_clamps_right",
            input: b"\x1b[99C",
            cursor: Some((0, 23)),
            ..BASE
        },
...
fn conformance_cursor_margins() {
    check(&[
        ...
        Case {
            name: "cuu_stops_at_top_margin",
            input: b"\x1b[3;7r\x1b[6;1H\x1b[10A",
            cursor: Some((2, 0)),
            ..BASE
        },
        // CUD stops at the BOTTOM margin when starting inside the region.
        Case {
            name: "cud_stops_at_bottom_margin",
            input: b"\x1b[3;7r\x1b[4;1H\x1b[10B",
            cursor: Some((6, 0)),
            ..BASE
        },
        // CUU started ABOVE the region clamps to the screen top, not the margin.
        Case {
            name: "cuu_above_region_clamps_screen_top",
            input: b"\x1b[4;5r\x1b[3;1H\x1b[10A",
            cursor: Some((0, 0)),
            ..BASE
        },
        // CUD started BELOW the region clamps to the screen bottom.
        Case {
            name: "cud_below_region_clamps_screen_bottom",
            input: b"\x1b[4;5r\x1b[7;1H\x1b[10B",
            cursor: Some((7, 0)),
            ..BASE
        },
    ]);
...
fn conformance_decstbm() {
    check(&[
        ...
        Case {
            name: "decstbm_sets_and_homes",
            input: b"\x1b[2;6r",
            scroll_region: Some((1, 5)),
            cursor: Some((0, 0)),
            ..BASE
        },
        // Bare CSI r resets to full screen (8 rows → (0,7)).
        Case {
            name: "decstbm_reset_full",
            input: b"\x1b[2;6r\x1b[r",
            scroll_region: Some((0, 7)),
            ..BASE
        },
        // Inverted / equal margins (Pt >= Pb) are IGNORED → full screen.
        Case {
            name: "decstbm_equal_ignored",
            input: b"\x1b[3;3r",
            scroll_region: Some((0, 7)),
            ..BASE
        },
        Case {
            name: "decstbm_inverted_ignored",
            input: b"\x1b[6;2r",
            scroll_region: Some((0, 7)),
            ..BASE
        },
        ...
        Case {
            name: "decstbm_overlarge_clamps",
            input: b"\x1b[2;99r",
            scroll_region: Some((1, 7)),
            cursor: Some((0, 0)),
            ..BASE
        },
    ]);
...
fn conformance_decom() {
    check(&[
        ...
        Case {
            name: "decom_homes_to_region_top",
            input: b"\x1b[5;8r\x1b[?6h",
            origin: Some(true),
            cursor: Some((4, 0)),
            ..BASE
        },
        ...
        Case {
            name: "decom_cup_region_relative",
            input: b"\x1b[5;8r\x1b[?6h\x1b[3;1H",
            cursor: Some((6, 0)),
            ..BASE
        },
        // Reset (`?6l`) returns to absolute addressing.
        Case {
            name: "decom_reset_absolute",
            input: b"\x1b[5;8r\x1b[?6h\x1b[?6l\x1b[3;1H",
            origin: Some(false),
            cursor: Some((2, 0)),
            ..BASE
        },
        ...
        Case {
            name: "decom_clamps_to_region_bottom",
            input: b"\x1b[2;4r\x1b[?6h\x1b[99;1H",
            cursor: Some((3, 0)),
            ..BASE
        },
    ]);
...
fn conformance_tabs() {
    check(&[
        ...
        Case {
            name: "hts_sets_stop",
            input: b"\x1b[1;4H\x1bH\x1b[1;1H\t",
            cursor: Some((0, 3)),
            ..BASE
        },
        ...
        Case {
            name: "tbc_clear_at_cursor",
            input: b"\t\x1b[0g\x1b[1;1H\t",
            cursor: Some((0, 16)),
            ..BASE
        },
    ]);
...
fn conformance_ed_el() {
    check(&[
        ...
        Case {
            ...
            rows: 2,
            cols: 10,
            input: b"0123456789\x1b[1;5H\x1b[0K",
            cursor: Some((0, 4)),
            rows_text: &[(0, "0123      ")],
            ..BASE
        },
        ...
        Case {
            ...
            rows: 2,
            cols: 10,
            input: b"0123456789\x1b[1;5H\x1b[1K",
            cursor: Some((0, 4)),
            rows_text: &[(0, "     56789")],
            ..BASE
        },
        // EL 2 (whole line).
        Case {
            name: "el_2_whole_line",
            rows: 2,
            cols: 10,
            input: b"0123456789\x1b[1;5H\x1b[2K",
            cursor: Some((0, 4)),
            rows_text: &[(0, "          ")],
            ..BASE
        },
...
fn conformance_insert_delete_erase() {
    check(&[
        ...
        Case {
            ...
            rows: 1,
            cols: 8,
            input: b"abcdefg\x1b[1;2H\x1b[@",
            cursor: Some((0, 1)),
            rows_text: &[(0, "a bcdefg")],
            ..BASE
        },
        // ICH explicit (2) with overflow lost: "ABCDEFGH" cursor col2 → "AB  CDEF".
        Case {
            name: "ich_explicit_overflow_lost",
            rows: 1,
            cols: 8,
            input: b"ABCDEFGH\x1b[1;3H\x1b[2@",
            cursor: Some((0, 2)),
            rows_text: &[(0, "AB  CDEF")],
            ..BASE
        },
        ...
        Case {
            ...
            rows: 1,
            cols: 8,
            input: b"ABCDEFGH\x1b[1;3H\x1b[2P",
            cursor: Some((0, 2)),
            rows_text: &[(0, "ABEFGH  ")],
            ..BASE
        },
        ...
        Case {
            ...
            rows: 1,
            cols: 8,
            input: b"ABCDEFGH\x1b[1;3H\x1b[2X",
            cursor: Some((0, 2)),
            rows_text: &[(0, "AB  EFGH")],
            ..BASE
        },
        ...
        Case {
            name: "ich_does_not_split_wide",
            rows: 1,
            cols: 4,
            input: "好x\x1b[1;2H\x1b[@".as_bytes(),
            cursor: Some((0, 1)),
            cells: &[(0, 0, Expect::Blank), (0, 3, Expect::Text("x"))],
            ..BASE
        },
    ]);
}
...
fn conformance_insert_delete_line() {
    check(&[
        ...
        Case {
            ...
            input: b"AAAA\r\nBBBB\r\nCCCC\r\nDDDD\x1b[2;3H\x1b[L",
            cursor: Some((1, 0)),
            rows_text: &[(0, "AAAA"), (1, "    "), (2, "BBBB"), (3, "CCCC")],
            ..BASE
        },
        ...
        Case {
            ...
            input: b"AAAA\r\nBBBB\r\nCCCC\r\nDDDD\x1b[2;3H\x1b[M",
            cursor: Some((1, 0)),
            rows_text: &[(0, "AAAA"), (1, "CCCC"), (2, "DDDD"), (3, "    ")],
            ..BASE
        },
        // IL is a no-op when the cursor is OUTSIDE the scroll region.
        Case {
            name: "il_noop_outside_region",
            rows: 4,
            cols: 4,
            input: b"AAAA\r\nBBBB\r\nCCCC\r\nDDDD\x1b[1;3r\x1b[4;1H\x1b[L",
            rows_text: &[(0, "AAAA"), (1, "BBBB"), (2, "CCCC"), (3, "DDDD")],
            ..BASE
        },
    ]);
}
...
fn conformance_erase_clears_whole_wide_char() {
    ...
    check(&[
        ...
        Case {
            name: "ech_clears_orphan_spacer",
            rows: 1,
            cols: 4,
            input: "好x\x1b[1;1H\x1b[X".as_bytes(),
            cursor: Some((0, 0)),
            cells: &[
                (0, 0, Expect::Blank),
                (0, 1, Expect::Blank),
        ...
        Case {
            name: "ech_clears_orphan_grapheme",
            rows: 1,
            cols: 4,
            input: "好x\x1b[1;2H\x1b[X".as_bytes(),
            cursor: Some((0, 1)),
            cells: &[
                (0, 0, Expect::Blank),
                (0, 1, Expect::Blank),
        ...
        Case {
            name: "el1_clears_orphan_spacer",
            rows: 1,
            cols: 4,
            input: "x好\x1b[1;2H\x1b[1K".as_bytes(),
            cursor: Some((0, 1)),
            cells: &[
                (0, 0, Expect::Blank),
                (0, 1, Expect::Blank),
...
fn conformance_rep() {
    check(&[
        ...
        Case {
            name: "rep_cleared_by_newline",
            input: b"a\r\n\x1b[3b",
            cursor: Some((1, 0)),
            cells: &[(0, 0, Expect::Text("a")), (1, 0, Expect::Blank)],
            ..BASE
        },
    ]);
}
...
fn conformance_cht_cbt() {
    check(&[
        ...
        Case {
            ...
            rows: 8,
            cols: 40,
            input: b"\x1b[1;3H\x1b[Z",
            cursor: Some((0, 0)),
            ..BASE
        },
        // CHT then CBT round-trips back to home (stop-aligned).
        Case {
            name: "cht_cbt_round_trip",
            rows: 8,
            cols: 40,
            input: b"\x1b[3I\x1b[3Z",
            cursor: Some((0, 0)),
            ..BASE
        },
    ]);
...
fn conformance_cnl_cpl() {
    check(&[
        ...
        Case {
            ...
            input: b"\x1b[Ex",
            cursor: Some((1, 1)),
            cells: &[(1, 0, Expect::Text("x"))],
            ..BASE
        },
        // CNL clamps at the bottom row.
        Case {
            name: "cnl_clamps_bottom",
            input: b"\x1b[99Ex",
            cursor: Some((7, 1)),
            cells: &[(7, 0, Expect::Text("x"))],
            ..BASE
        },
        ...
        Case {
            name: "cpl_2",
            input: b"\x1b[6;10H\x1b[2Fx",
            cursor: Some((3, 1)),
            cells: &[(3, 0, Expect::Text("x"))],
            ..BASE
        },
    ]);
}
...
fn conformance_attach_zero_width() {
    check(&[
        ...
        Case {
            name: "zwj_after_wide",
            input: b"\x1b[1;11H\xe5\xa5\xbd\x1b[m\xcc\x81\x1b[m",
            cells: &[(0, 10, Expect::Text("好\u{0301}")), (0, 11, Expect::Spacer)],
            ..BASE
        },
        ...
        Case {
            name: "zwj_at_last_col_pending_wrap",
            input: b"\x1b[1;24Ha\x1b[m\xcc\x81\x1b[m",
            cursor: Some((0, 23)),
            cells: &[(0, 22, Expect::Blank), (0, 23, Expect::Text("a\u{0301}"))],
            ..BASE
        },
    ]);
}
...
fn ed3_clears_scrollback() {
    ...
    assert!(
        ...
        "scrollback should be populated before ED 3"
    );
    p.advance(&mut s, b"\x1b[3J");
    p.flush(&mut s);
    assert!(
        s.scrollback.is_empty(),
        "ED 3 must clear the scrollback buffer"
    );
}
